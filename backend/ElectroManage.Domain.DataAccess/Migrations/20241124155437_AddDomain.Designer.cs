...
namespace ElectroManage.Domain.DataAccess.Migrations
{
    ...
    [Migration("20241124155437_AddDomain")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CompanyConsumptionLimit", b =>
                {
                    b.Property<long>("CompaniesId")
                        .HasColumnType("bigint");

                    b.Property<long>("ConsumptionLimitsId")
                        .HasColumnType("bigint");

                    b.HasKey("CompaniesId", "ConsumptionLimitsId");

                    b.HasIndex("ConsumptionLimitsId");

                    b.ToTable("CompanyConsumptionLimit");
                });
            ...
            modelBuilder.Entity("ElectroManage.Domain.Entites.Sucursal.ConsumptionLimit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CompanyConsumptionLimit", b =>
                {
                    ...
                    b.HasOne("ElectroManage.Domain.Entites.Sucursal.ConsumptionLimit", null)
                        .WithMany()
                        .HasForeignKey("ConsumptionLimitsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
